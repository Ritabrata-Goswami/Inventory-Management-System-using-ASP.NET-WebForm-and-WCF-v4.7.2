        ...
        <div class="ParentFormContainer">
            ...
            <div class="form-container">
                ...
                <div class="btn-container">
                    <asp:Button runat="server" Text="Submit" ID="BtnSubmit" CssClass="submit-btn" OnClientClick="return SubmitStockOut(event)"/>
                </div>
            </div>
        </div>
        <div class="ParentDisplayContainer">
            <div class="header-container">
                <h2>Display Stock Out</h2>
            </div>
    ...
    <script type="text/javascript">
        function SubmitStockOut(event) {
            ...
            $.ajax({
                ...
                url: "http://localhost:55391/Wcf_ServiceApi.svc/PostStockOut",
