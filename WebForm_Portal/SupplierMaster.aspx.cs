...
public partial class SupplierMaster : System.Web.UI.Page
{
    ...
    protected async Task LoadGridView()
    {
        ...
        try
        {
            ...
            HttpResponseMessage WebRes = await WebClient.GetAsync("http://localhost:55391/Wcf_ServiceApi.svc/GetVendorMaster");
            string GetDataStr = await WebRes.Content.ReadAsStringAsync();
            GetAsyncVendorMasterData GetDataObj = JsonConvert.DeserializeObject<GetAsyncVendorMasterData>(GetDataStr);

            string StatusMsg = GetDataObj.GetVendorMasterResult.Cls_CommRes.Message;
            int StatusCode = GetDataObj.GetVendorMasterResult.Cls_CommRes.StatusCode;
            List<GetVendorMaster> List_VendorMaster = GetDataObj.GetVendorMasterResult.Cls_GetVendorMasterList;

            GridView_VendorMaster.DataSource = List_VendorMaster;
    ...
    protected async void GridView_RowDelete(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string TableName = "SupplierMaster";
        try
        {
